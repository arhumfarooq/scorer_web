...
class UserPlayerDetailedScreen extends StatelessWidget {
    // final FacilDashboardController controller = Get.put(FacilDashboardController());
 
   
   UserPlayerDetailedScreen({super.key});
  ...
  CustomDashboardContainer(
                  ...
                  padding: 12.w,
                    ...
                    isshow: true,
                     ...
                     SizedBox(height: 40 .h),
LoginButton(text: "delete_player".tr,ishow: true,image: Appimages.delete,color: AppColors.redColor,),
   SizedBox(height: 20 .h),
LoginButton(text: "edit_player".tr,ishow: true,icon: Icons.edit,color: AppColors.forwardColor,),
